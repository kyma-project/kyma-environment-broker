...
func TestDeprovisioning_BuildRuntimeAlicloud(t *testing.T) {
	// given
	...
	// when
	resp = suite.CallAPI("DELETE", fmt.Sprintf("oauth/v2/service_instances/%s?accepts_incomplete=true&plan_id=72efa867-7b54-4d59-8df7-68f4759ff271&service_id=47c9dcbf-ff30-448e-ab36-d3bad66ba281", iid),
		``)
	defer func() { _ = resp.Body.Close() }()
	opID = suite.DecodeOperationID(resp)
	suite.FinishDeprovisioningOperationByKIM(opID)
