...
func NewClusterOrchestrationProcessingQueue(ctx context.Context, db storage.BrokerStorage, provisionerClient provisioner.Client,
	...
	queue := process.NewQueue(orchestrateClusterManager, logs, "cluster-orchestration-processing-queue", cfg.Broker.WorkerHealthCheckWarnInterval, cfg.Broker.WorkerHealthCheckInterval)
