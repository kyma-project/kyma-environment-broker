...
describe('SKR Trial suspension test', function () {
    ...
    it('should wait until Trial Cleanup CronJob triggers suspension', async function() {
        const rs = await kcp.ensureLatestGivenOperationTypeIsInGivenState(options.instanceID, suspensionOperationType, inProgressOperationState, trialCleanupTriggerTimeout);
