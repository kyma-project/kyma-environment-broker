...
func (h *orchestrationHandler) AttachRoutes(router chi.Router) {
	router.Get("/orchestrations", h.listOrchestration)
	router.Get("/orchestrations/{orchestration_id}", h.getOrchestration)
	router.Put("/orchestrations/{orchestration_id}/cancel", h.cancelOrchestrationByID)
	router.Get("/orchestrations/{orchestration_id}/operations", h.listOperations)
	router.Get("/orchestrations/{orchestration_id}/operations/{operation_id}", h.getOperation)
	router.Post("/orchestrations/{orchestration_id}/retry", h.retryOrchestrationByID)
}

func (h *orchestrationHandler) getOrchestration(w http.ResponseWriter, r *http.Request) {
	orchestrationID := chi.URLParam(r, "orchestration_id")
