...
func TestUpdateEndpoint_AdditionalVolumeGiB_NegativeValueRejected(t *testing.T) {
	instance := internal.Instance{
		InstanceID:    instanceID,
		ServicePlanID: broker.AWSPlanID,
		Parameters: internal.ProvisioningParameters{
	...
	_, err := svc.Update(context.Background(), instanceID, domain.UpdateDetails{
		PlanID:        broker.AWSPlanID,
		RawParameters: json.RawMessage(`{"additionalVolumeGiB": -5}`),
		RawContext:    json.RawMessage(`{"active":true}`),
	}, true)
...
func TestUpdateEndpoint_AdditionalVolumeGiB_RejectedForExcludedPlan(t *testing.T) {
	instance := internal.Instance{
		InstanceID:    instanceID,
	...
	_, err := svc.Update(context.Background(), instanceID, domain.UpdateDetails{
		PlanID:        broker.AzureLitePlanID,
		RawParameters: json.RawMessage(`{"additionalVolumeGiB": 10}`),
		RawContext:    json.RawMessage(`{"active":true}`),
	}, true)
