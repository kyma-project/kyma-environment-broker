...
func (b *UpdateEndpoint) update(ctx context.Context, instanceID string, details domain.UpdateDetails, asyncAllowed bool) (domain.UpdateServiceSpec, error) {
	...
	lastDeprovisioningOperation, err := b.operationStorage.GetLastOperationByTypesWithAllStates(instance.InstanceID, []internal.OperationType{internal.OperationTypeDeprovision})
