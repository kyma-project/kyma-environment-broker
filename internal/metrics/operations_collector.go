...
// - keb_operations_{plan_name}_provisioning_failed_total
// - keb_operations_{plan_name}_provisioning_in_progress_total
// - keb_operations_{plan_name}_provisioning_succeeded_total
// - keb_operations_{plan_name}_deprovisioning_failed_total
// - keb_operations_{plan_name}_deprovisioning_in_progress_total
// - keb_operations_{plan_name}_deprovisioning_succeeded_total
