...
//
// - keb_instances_total - total number of all instances
// - keb_global_account_id_instances_total - total number of all instances per global account
// - keb_ers_context_license_type_total - count of instances grouped by license types
