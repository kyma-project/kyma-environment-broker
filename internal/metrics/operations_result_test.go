...
func TestOperationsResult(t *testing.T) {
	...
	t.Run(testName, func(t *testing.T) {
		...
		eventBroker.Subscribe(process.OperationFinished{}, resultsCollector.UpdateCounters)
		...
		err = resultsCollector.UpdateCounters(context.Background(), process.OperationFinished{Operation: opEvent})
		assert.NoError(t, err)
