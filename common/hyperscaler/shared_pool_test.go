		...
		for _, testCase := range []struct {
		...
		}{
			{
				...
				secretBindings: []runtime.Object{
					...
					newSecretBinding("sb4", "s4", "openstack-eu-de-1", true, euAccess),
					newSecretBinding("sb5", "s5", "openstack-eu-de-2", true, euAccess),
				},
				shoots: []runtime.Object{
					newShoot("sh1", "sb1"),
					newShoot("sh2", "sb1"),
			...
			},
			{
				...
				secretBindings: []runtime.Object{
					...
					newSecretBinding("sb4", "s4", "openstack-eu-de-1", true, euAccess),
					newSecretBinding("sb5", "s5", "openstack-eu-de-2", true, euAccess),
					newSecretBinding("sb6", "s6", "openstack-eu-de-1", true, euAccess),
				},
				shoots: []runtime.Object{
					newShoot("sh1", "sb4"),
					newShoot("sh2", "sb4"),
