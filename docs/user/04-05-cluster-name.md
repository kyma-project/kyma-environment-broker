...
During provisioning, the name parameter is mandatory and must consist of 1–64 characters, using only uppercase letters, lowercase letters, digits, or hyphens.
