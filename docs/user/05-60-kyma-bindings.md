...
You can specify the duration for which the generated kubeconfig is valid by providing the `expiration_seconds` in the `parameter` field of the request body. 
