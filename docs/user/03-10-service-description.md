...
| **additionalWorkerNodePools.list[<sup>1</sup>](#update)**             | array  | Defines a custom list of additional worker node pools                               |    No    | None              |
| **additionalWorkerNodePools.skipModification[<sup>1</sup>](#update)** | bool   | Defines whether to skip modification of additional worker node pools                |    No    | None              |
