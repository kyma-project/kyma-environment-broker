...
| **modules.channel**                              | string | Enables the user to define their preferred release channel                                                            |    No    | Taken from the runtimeConfiguration setting, where your Kyma resource spec channel is specified per plan            |
