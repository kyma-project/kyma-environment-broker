...
| **APP_DRY_RUN** | <code>false</code> | If <code>true</code>, the job only logs what would be deleted without actually removing any data. |
...
| **APP_TEST_RUN** | <code>false</code> | If <code>true</code>, runs the job in test mode. |
...
| **APP_TEST_RUN** | <code>false</code> | If <code>true</code>, runs the job in test mode (no real deletions, for testing purposes). |
| **APP_TEST_SUBACCOUNT_&#x200b;ID** | <code>prow-keb-trial-suspension</code> | Subaccount ID used for test runs. |
| **DATABASE_EMBEDDED** | <code>true</code> | - |
