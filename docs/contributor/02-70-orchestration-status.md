...
2. Make a call to the Kyma Environment Broker with a proper **Authorization** [request header](01-10-authorization.md) to verify that the orchestration succeeded.
...
Make a call to the Kyma Environment Broker with a proper **Authorization** [request header](01-10-authorization.md) to verify that the orchestration succeeded.
...
2. Make a call to the Kyma Environment Broker with a proper **Authorization** [request header](01-10-authorization.md) to fetch the list of the upgrade operations for a given orchestration.
...
2. Make a call to the Kyma Environment Broker with a proper **Authorization** [request header](01-10-authorization.md) to fetch the details for given operation.
