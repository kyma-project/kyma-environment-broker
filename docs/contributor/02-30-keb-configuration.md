...
| **APP_BROKER_RESTRICT_&#x200b;TO_ALLOWED_GLOBAL_&#x200b;ACCOUNT_IDS** | <code>false</code> | if true, restricts provisioning to only the global account IDs listed in AllowedGlobalAccountIDs. |
