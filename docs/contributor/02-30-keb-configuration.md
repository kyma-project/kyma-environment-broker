...
| **APP_BTP_REGION_&#x200b;MIGRATION_SAP_&#x200b;CONVERGED_CLOUD_&#x200b;FILE_PATH** | <code>/config/btpRegionsMigrationSapConvergedCloud.yaml</code> | Path to the mapping of deprecated BTP regions to their corresponding replacement regions in SAP Converged Cloud. |
