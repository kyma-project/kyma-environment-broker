...
| **APP_BROKER_&#x200b;ADDITIONAL_VOLUME_&#x200b;GB_ENABLED** | <code>false</code> | If true, exposes additionalVolumeGb parameter in the schema, allowing users to request extra disk on top of the default volume size. Requires dynamicVolumeSizeEnabled to be true. |
