...
| **APP_BTP_REGIONS_&#x200b;MIGRATION_SAP_&#x200b;CONVERGED_CLOUD_&#x200b;FILE_PATH** | <code>/config/btpRegionsMigrationSapConvergedCloud.yaml</code> | Path to the mapping of deprecated BTP regions to their corresponding replacement regions in SAP Converged Cloud. || **APP_CATALOG_FILE_&#x200b;PATH** | <code>/config/catalog.yaml</code> | Path to the service catalog configuration file. |
| **APP_BTP_REGIONS_&#x200b;MIGRATION_SAP_&#x200b;CONVERGED_CLOUD_&#x200b;FILE_PATH** | <code>/config/btpRegionsMigrationSapConvergedCloud.yaml</code> | Path to the mapping of deprecated BTP regions to their corresponding replacement regions in SAP Converged Cloud. |
