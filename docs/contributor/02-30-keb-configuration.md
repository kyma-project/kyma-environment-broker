...
| **APP_BROKER_&#x200b;ADDITIONAL_VOLUME_&#x200b;GI_MAX_SIZE** | <code>1000</code> | Maximum value (in Gi) allowed for the additionalVolumeSizeGi parameter. |
| **APP_BROKER_&#x200b;ADDITIONAL_VOLUME_&#x200b;GI_PLANS** | None | Plans for which the additionalVolumeSizeGi parameter is exposed in the schema. Requires dynamicVolumeSizeEnabled to be true. Leave empty to disable the feature. |
