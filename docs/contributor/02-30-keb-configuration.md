...
| **APP_BROKER_&#x200b;ADDITIONAL_VOLUME_&#x200b;GB_PLANS** | None | Plans for which the additionalVolumeGb parameter is exposed in the schema. Requires dynamicVolumeSizeEnabled to be true. Leave empty to disable the feature. |
