...
| **APP_BROKER_ENABLE_&#x200b;PLANS** | <code>azure,gcp,azure_lite,trial,aws,no-plan</code> | Comma-separated list of plan names enabled and available for provisioning in KEB. |
