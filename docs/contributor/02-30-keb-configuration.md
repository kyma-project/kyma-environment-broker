...
| **APP_INFRASTRUCTURE_&#x200b;MANAGER_USE_MACHINE_&#x200b;IMAGE_VERSION_SUFFIX** | <code>false</code> | If true, appends a machine-type-specific suffix (e.g. "-gen2") to the machine image version for Azure workers. |
