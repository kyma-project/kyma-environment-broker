...
| infrastructureManager.<br>useMachineImageVersionSuffix | If true, appends a machine-type-specific suffix (e.g. "-gen2") to the machine image version for Azure workers. | `False` |
