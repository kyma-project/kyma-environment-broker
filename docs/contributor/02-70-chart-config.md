...
| operationRecoveryDelay | Delay after startup before running a second scan for in-progress operations, to recover operations orphaned during rolling deployments. | `2m` |
