...
| broker.<br>additionalVolumeGbEnabled | If true, exposes additionalVolumeGb parameter in the schema, allowing users to request extra disk on top of the default volume size. Requires dynamicVolumeSizeEnabled to be true. | `false` |
