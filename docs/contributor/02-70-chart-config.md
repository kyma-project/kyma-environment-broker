...
| broker.<br>additionalVolumeGbPlans | Plans for which the additionalVolumeGb parameter is exposed in the schema. Requires dynamicVolumeSizeEnabled to be true. Leave empty to disable the feature. | `` |
