...
The dual-stack networking configuration allows users to provision Kyma instances with both IPv4 and IPv6 protocols simultaneously. This feature must be explicitly enabled at the provider level to make the option available during provisioning.
