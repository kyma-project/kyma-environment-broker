...
0. Sends a call to Provisioning API to deprovision the remaining Kyma runtime and waits until the environment is deleted, if previous test run was not able to deprovision Kyma runtime.
